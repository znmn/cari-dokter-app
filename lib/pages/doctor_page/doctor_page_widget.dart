...
class _DoctorPageWidgetState extends State<DoctorPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (distance != null && double.parse(distance) <= 30) {
      ...
      sumBiaya = 'Rp ${totalBiaya.toStringAsFixed(0)}';
    } else {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      color: MaterialKitTheme.of(context).secondaryBackground,
                      elevation: 2.0,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FaIcon(
                                      ...
                                      color:
                                          MaterialKitTheme.of(context).warning,
                                      size: 20.0,
                                    ),
                                  ),
                                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: MaterialKitStaticMap(
                          ...
                          fit: BoxFit.cover,
                          borderRadius: BorderRadius.circular(10.0),
                          markerColor: MaterialKitTheme.of(context).secondary,
                          zoom: 12,
                          tilt: 0,
                          rotation: 0,
                        ),
