...
Widget wrapWithModel<T extends MaterialKitModel>({
  required T model,
...
T createModel<T extends MaterialKitModel>(
...
abstract class MaterialKitModel {
...
class MaterialKitDynamicModels<T extends MaterialKitModel> {
  MaterialKitDynamicModels(this.defaultBuilder);
