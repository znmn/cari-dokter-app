...
class MaterialKitWebView extends StatefulWidget {
  const MaterialKitWebView({
    Key? key,
    required this.url,
    this.width,
    this.height,
  ...
  @override
  _MaterialKitWebViewState createState() => _MaterialKitWebViewState();
}

class _MaterialKitWebViewState extends State<MaterialKitWebView> {
  @override
