...
abstract class MaterialKitTheme {
  static MaterialKitTheme of(BuildContext context) {
...
class LightModeTheme extends MaterialKitTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFF0EBE7E);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFF9198B1);
  late Color primaryBackground = const Color(0xFFD2F3E8);
